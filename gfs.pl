...
Answer = [[Ans]],
string_concatenate(["[string(Check the i, j , k  components and the magnitude of both vectors.)]"],"",Hint_str),
Hint = [Hint_str],
...
Main_predicate = New_element_formed,
string_concatenate(["answer_types([[string(Direction Ratios = ),type(algebra_form),placeholder(string(Enter the values of a,b,c in integer form and separated by comma)),unit()]]),answer_types([[string(Direction Cosines = ),type(algebra_form),placeholder(string(Enter the values of l,m,n in integer or radical form and separated by comma)),unit()]])"],"",Answer_type_str),
Answer_type =  [Answer_type_str],
Answer = [3,[Ans]],
...
Main_predicate = New_element_formed,
string_concatenate(["answer_types([[string(latex(a\\\\hat{i} + b\\\\hat{j} + c\\\\hat{k}=)),type(algebra_form),placeholder(string(Enter the values of a,b,c in integer form and separated by comma)),unit()]])"],"",Answer_type_str),
Answer_type =  [Answer_type_str],
Answer = [3,[Ans]],
